                            ...
                            <div class="row">
                                <div class="col-sm-5">
                                    <div class="form-group"><label for="">PO Number</label>
                                        <input type="text" readonly required value="LPO-000{{ $poNumber }}" name="po_no" id="po_no" class="form-control">
                                    </div>
                                </div>
                                <div class="col-sm-5">
                                ...
                                <input type="hidden" value="{{ $quotation->project_id }}" name="project_id" placeholder="project id">
