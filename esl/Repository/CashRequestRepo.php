...
class CashRequestRepo
{
    ...
    public function fundRequest($cashData,$project)
    {


        $from_sage=VoucherType::where('iVoucherTypeID',$cashData->payment_mode)->first();
        ...
        CashRequest::create([
                ...
                'iVoucherID' => $cashData->payment_mode,
        ...
        VoucherType::where('iVoucherTypeID',$cashData->payment_mode)->update(['iDeftStartNo'=> $from_sage->iDeftStartNo+1]);
        return true;
    }
}
